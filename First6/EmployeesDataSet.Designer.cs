...
namespace First6 {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation _relationFK_dbo_Employees_dbo_Departments_DepartmentId;
        ...
        internal void InitVars(bool initTable) {
            ...
            this._relationFK_dbo_Employees_dbo_Departments_DepartmentId = this.Relations["FK_dbo.Employees_dbo.Departments_DepartmentId"];
        }
        ...
        private void InitClass() {
            ...
            this._relationFK_dbo_Employees_dbo_Departments_DepartmentId = new global::System.Data.DataRelation("FK_dbo.Employees_dbo.Departments_DepartmentId", new global::System.Data.DataColumn[] {
                        this.tableDepartments.DepartmentIdColumn}, new global::System.Data.DataColumn[] {
                        this.tableEmployees.DepartmentIdColumn}, false);
            this.Relations.Add(this._relationFK_dbo_Employees_dbo_Departments_DepartmentId);
        }
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(string EmployeeName, string Position, DepartmentsRow _parentDepartmentsRowByFK_dbo_Employees_dbo_Departments_DepartmentId) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Position,
                        null};
                if ((_parentDepartmentsRowByFK_dbo_Employees_dbo_Departments_DepartmentId != null)) {
                    columnValuesArray[3] = _parentDepartmentsRowByFK_dbo_Employees_dbo_Departments_DepartmentId[0];
                }
        ...
        public partial class DepartmentsRow : global::System.Data.DataRow {
            ...
            public EmployeesRow[] GetEmployeesRows() {
                if ((this.Table.ChildRelations["FK_dbo.Employees_dbo.Departments_DepartmentId"] == null)) {
                    return new EmployeesRow[0];
                }
                else {
                    return ((EmployeesRow[])(base.GetChildRows(this.Table.ChildRelations["FK_dbo.Employees_dbo.Departments_DepartmentId"])));
                }
            }
        }
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public DepartmentsRow DepartmentsRow {
                get {
                    return ((DepartmentsRow)(this.GetParentRow(this.Table.ParentRelations["FK_dbo.Employees_dbo.Departments_DepartmentId"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_dbo.Employees_dbo.Departments_DepartmentId"]);
                }
            }
...
namespace First6.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmployeeName], [Position], [DepartmentId]) VALUES" +
                " (@EmployeeName, @Position, @DepartmentId)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [EmployeeName] = @EmployeeName, [Position] = @Positi" +
                "on, [DepartmentId] = @DepartmentId WHERE (([EmployeeId] = @Original_EmployeeId))" +
                "";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmployeeId, EmployeeName, Position, DepartmentId FROM dbo.Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string EmployeeName, string Position, int DepartmentId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EmployeeName, string Position, int DepartmentId, int Original_EmployeeId) {
            if ((EmployeeName == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
